...
@interface XBSearchVC ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource,CusSearchDelegate>{
...
- (void)viewDidLoad {
    ...
    //初始搜索
    self.cusSearchVC = [[CusSearchVC alloc]initWithplaceholder:@"请输入你要搜索的课程内容" WithAdresaName:@"XBSearchVC" WithParentOrDeleagteVC:self];
}
