...
/** 高林修改 聊天chat 更多功能按钮 */
@property (nonatomic, strong) GLButton *photoButton;
@property (nonatomic, strong) GLButton *takePicButton;
@property (nonatomic, strong) GLButton *locationButton;
@property (nonatomic, strong) GLButton *videoButton;
@property (nonatomic, strong) GLButton *audioCallButton;
@property (nonatomic, strong) GLButton *videoCallButton;
...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    _photoButton =[GLButton buttonWithType:UIButtonTypeCustom];
    ...
    [_photoButton addTarget
     :self action:@selector(photoAction) forControlEvents:UIControlEventTouchUpInside];
    _photoButton.tag = MOREVIEW_BUTTON_TAG;
    [_scrollview addSubview:_photoButton];
    
    [_photoButton setTitle:@"照片" forState:UIControlStateNormal];
    [_photoButton setTitleColor:[UIColor hx_colorWithHexRGBAString:@"1976d2"] forState:UIControlStateNormal];
    
//    NSMutableDictionary *normalAttrs = [NSMutableDictionary dictionary];
//    normalAttrs[NSForegroundColorAttributeName] = [UIColor hx_colorWithHexRGBAString:@"111111"];
//    normalAttrs[NSFontAttributeName] = [UIFont systemFontOfSize:14];
//    
//    NSMutableAttributedString *attriString = [[NSMutableAttributedString alloc] initWithString:@"照片"];
//    [attriString addAttributes:normalAttrs range:NSMakeRange(0, MAXFLOAT)];
    
//    [_photoButton setAttributedTitle:attriString forState:UIControlStateNormal];
    
//    [_photoButton setAttributedTitle:normalAttrs forState:UIControlStateNormal
//    [_photoButton setTitleColor:[UIColor hx_colorWithHexRGBAString:@"111111"] forState:UIControlStateNormal];
    
    _locationButton =[GLButton buttonWithType:UIButtonTypeCustom];
    ...
    _takePicButton =[GLButton buttonWithType:UIButtonTypeCustom];
    ...
    if (type == EMChatToolbarTypeChat) {
        ...
        _audioCallButton =[GLButton buttonWithType:UIButtonTypeCustom];
        ...
        _videoCallButton =[GLButton buttonWithType:UIButtonTypeCustom];
