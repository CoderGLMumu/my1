...
@interface XBOffLiveVoiceShowVC ()
...
@implementation XBOffLiveVoiceShowVC
...
//    view.backgroundColor = [UIColor redColor];
    ...
    view.frame = CGRectMake(0, 0, GLScreenW, GLScreenW * 9/16);
...
- (void)willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    if (toInterfaceOrientation == UIInterfaceOrientationPortrait) {
        ...
        /** 正常 */
        [self setImageToView:self.liveitem.thumb2 SetImageV:self.BGimageV InView:nil OrSize:CGSizeMake(GLScreenW, GLScreenW * 9/16 )];
        ...
        /** 横屏 */
        [self setImageToView:self.liveitem.thumb2 SetImageV:self.BGimageV InView:nil OrSize:[UIScreen mainScreen].bounds.size];
...
- (IBAction)ClickPayButton:(UIButton *)sender {
    ...
    __weak XBOffLiveVoiceShowVC *wself = self;
