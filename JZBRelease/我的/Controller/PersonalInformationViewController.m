...
//            self.businessLabel.text = self.users.business;
            ...
            /** 缓存 */
            self.users.avatar = [AddHostToLoadPIC AddHostToLoadPICWithString:self.users.avatar];
...
//    }
    ...
    UIImage *smallImage = [self thumbnailWithImageWithoutScale:image size:CGSizeMake(130, 130)];
