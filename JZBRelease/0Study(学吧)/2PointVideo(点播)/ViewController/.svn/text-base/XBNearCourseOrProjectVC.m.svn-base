...
@interface XBNearCourseOrProjectVC () <BMKMapViewDelegate , BMKLocationServiceDelegate ,BMKGeoCodeSearchDelegate>
...
@implementation XBNearCourseOrProjectVC
...
- (BMKAnnotationView *)mapView:(BMKMapView *)mapView viewForAnnotation:(id <BMKAnnotation>)annotation
{
    ...
    if ([self.userType isEqualToString:@"0"]) {
        ...
        annotationView.image = [UIImage imageNamed:@"add_blue"];
    }else if ([self.userType isEqualToString:@"2"]) {
        annotationView.image = [UIImage imageNamed:@"add_green"];
    }else if ([self.userType isEqualToString:@"3"]) {
        annotationView.image = [UIImage imageNamed:@"add_orange"];
    }else {
        annotationView.image = [UIImage imageNamed:@"rm_contacts_position"];
    }
