    ...
    if (!self.isBQDetail) {
        if (self.isQustionOwner) {
            ...
            if (!self.zanImageView) {
                self.zanCountBtn  = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, width, 44)];
                self.zanImageView = [[UIImageView alloc]initWithFrame:CGRectMake(width / 2 - 15 - 5, (44 - 15) / 2, 15, 15)];
                [self.zanImageView setImage:[UIImage imageNamed:@"WDXQ_Thumb_up"]];
                [self.zanCountBtn addSubview:self.zanImageView];
                
                self.zanCountLabel = [[UILabel alloc]initWithFrame:CGRectMake(width / 2 + 5, (44 - 21) / 2, width / 2 - 5, 21)];
                ...
                UIImageView *intevalImageView = [[UIImageView alloc]initWithFrame:CGRectMake(width - 1, (44 - 13) / 2, 1, 13)];
            ...
            if ([((EvaluateModel *)model).is_like integerValue] == 1) {
                [self.zanImageView setImage:[UIImage imageNamed:@"WDXQ_DZ_BLUE"]];
            }else{
            ...
            if (!self.rewardImageView) {
                self.rewardCountBtn  = [[UIButton alloc]initWithFrame:CGRectMake(width, 0, width, 44)];
                self.rewardImageView = [[UIImageView alloc]initWithFrame:CGRectMake(width / 2 - 18 - 5, (44 - 18) / 2, 18, 18)];
                AppDelegate *appDelegate = (AppDelegate*)[UIApplication sharedApplication].delegate;
                
               // if (appDelegate.checkpay) {
                    [self.rewardImageView setImage:[UIImage imageNamed:@"WDXQ_DS"]];
              ...
              //  }else{
               ...
               // }
                ...
                self.rewardCountLabel = [[UILabel alloc]initWithFrame:CGRectMake(width / 2 + 5, (44 - 21) / 2, width / 2 - 5, 21)];
            ...
            if (!self.commentImageView) {
                self.commentCountBtn  = [[UIButton alloc]initWithFrame:CGRectMake(width * 2, 0, width, 44)];
                self.commentImageView = [[UIImageView alloc]initWithFrame:CGRectMake(width / 2 - 15 - 5, (44 - 15) / 2, 15, 15)];
                [self.commentImageView setImage:[UIImage imageNamed:@"WDXQ_comments"]];
                [self.commentCountBtn addSubview:self.commentImageView];
                
                self.commentCountLabel = [[UILabel alloc]initWithFrame:CGRectMake(width / 2 + 5, (44 - 21) / 2, width / 2 - 5, 21)];
            ...
            if (!self.cainaBtn) {
                self.cainaBtn = [[UIButton alloc]initWithFrame:CGRectMake(3 * width, 0, width, 44)];
                [self addSubview:self.cainaBtn];
                UIImageView *caiImageView = [[UIImageView alloc]initWithFrame:CGRectMake(width / 2 - 15 - 5, (44 - 15) / 2, 15, 15)];
                [caiImageView setImage:[UIImage imageNamed:@"WD_CNicon"]];
                [self.cainaBtn addSubview:caiImageView];
                
                UILabel *caiLabel = [[UILabel alloc]initWithFrame:CGRectMake(width / 2 + 5, (44 - 21) / 2, width / 2 - 5, 21)];
        ...
        if (!self.commentImageView) {
            self.commentCountBtn  = [[UIButton alloc]initWithFrame:CGRectMake(width, 0, width, 44)];
            self.commentImageView = [[UIImageView alloc]initWithFrame:CGRectMake(width / 2 - 15 - 5, (44 - 15) / 2, 15, 15)];
            [self.commentImageView setImage:[UIImage imageNamed:@"WDXQ_comments"]];
            [self.commentCountBtn addSubview:self.commentImageView];
