...
//    @property (weak, nonatomic) IBOutlet UILabel *userNameLabel;
    ...
    [self.touxiangImageView sd_setImageWithURL:[NSURL URLWithString:[AddHostToLoadPIC AddHostToLoadPICWithString:model.recode_u_avatar]] placeholderImage:[UIImage imageNamed:@"HX_img_head"] completed:^(UIImage *image, NSError *error, EMSDImageCacheType cacheType, NSURL *imageURL) {
