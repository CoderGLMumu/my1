...
- (void)updateWithModel:(CourseTimeModel *)models{
    ...
    if (!imageView) {
        if (!self.isTwoSmall) {
            if (!self.isThreeSmall) {
                imageView = [[UIImageView alloc]initWithFrame:CGRectMake(10, 8, self.frame.size.width - 13.5, 115)];
            }else{
                imageView = [[UIImageView alloc]initWithFrame:CGRectMake(10, 0, self.frame.size.width - 13.5, 115)];
            }
        }else{
            if (!self.isThreeSmall) {
                imageView = [[UIImageView alloc]initWithFrame:CGRectMake(3.5, 8, self.frame.size.width - 13.5, 115)];
            }else{
                imageView = [[UIImageView alloc]initWithFrame:CGRectMake(3.5, 0, self.frame.size.width - 13.5, 115)];
            }
        }
   ...
   // }
    ...
    if (!backgroundView) {
        backgroundView = [[UIView alloc]initWithFrame:CGRectMake(0, 115 - 22, imageView.frame.size.width, 22)];
        [backgroundView setBackgroundColor:[UIColor blackColor]];
        backgroundView.alpha = 0.7;
        [imageView addSubview:backgroundView];
        
        backgroundView1 = [[UIView alloc]initWithFrame:CGRectMake(0, 115 - 22, imageView.frame.size.width, 22)];
