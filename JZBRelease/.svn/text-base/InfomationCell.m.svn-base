...
- (void)setModel:(InfomationModel *)model{
    ...
    if (self.picImageView.hidden) {
        [self.bottomView setFrame:CGRectMake(0, self.titleLabel.frame.origin.y + self.titleLabel.frame.size.height + 6, SCREEN_WIDTH, 38)];
        ...
        [self.bottomView setFrame:CGRectMake(0, self.picImageView.frame.origin.y + self.picImageView.frame.size.height + 8, SCREEN_WIDTH, 38)];
        [intevalView setFrame:CGRectMake(10, self.bottomView.frame.origin.y + self.bottomView.frame.size.height - 0.8, SCREEN_WIDTH - 20, 0.8)];
    }
    ...
    NSString *moveStr = [model.share_count stringByAppendingString:@"转"];
