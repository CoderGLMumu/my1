...
- (void)DownLoadData
{
    ...
    if (isAccess) {
        if ([self.liveTableView.mj_header isRefreshing]) {
            return ;
        }
    }
    isAccess = YES;
