...
-(void)viewDidAppear:(BOOL)animated{
    ...
    if (!userInfo && !userInfo.token) {
        ...
        NSString *path = [[ValuesFromXML getValueWithName:@"Sever_Absolute_Address" WithKind:XMLTypeNetPort]stringByAppendingPathComponent:[NSString stringWithFormat:[ValuesFromXML getValueWithName:@"Get_Activity_Detail" WithKind:XMLTypeNetPort],self.activity_id,userInfo.token]];
...
- (void)showShareActionSheet:(UIView *)view
{
    ...
    NSString *shareUrl_str = [[ValuesFromXML getValueWithName:@"Sever_Absolute_Address" WithKind:XMLTypeNetPort] stringByAppendingFormat:@"%@", [NSString stringWithFormat:@"/Share/Activity/info/id/%@.html",self.model.activity_id]];
