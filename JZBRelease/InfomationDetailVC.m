...
@interface InfomationDetailVC ()<UIWebViewDelegate>{
    UIWebView *web;
    BOOL isFinish;
}
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    if (!userInfo && !userInfo.token) {
        ...
        NSString *path = [[ValuesFromXML getValueWithName:@"Sever_Absolute_Address" WithKind:XMLTypeNetPort] stringByAppendingPathComponent:[NSString stringWithFormat:[ValuesFromXML getValueWithName:@"Article_Detail_URL" WithKind:XMLTypeNetPort],self.infoID,userInfo.token]];
...
//    NSString *shareUrl_str = [[ValuesFromXML getValueWithName:@"Sever_Absolute_Address" WithKind:XMLTypeNetPort]stringByAppendingPathComponent:[NSString stringWithFormat:@"Share/Article/info/id/%@.html",self.infoID]];
    ...
    NSString *shareUrl_str = [[ValuesFromXML getValueWithName:@"Sever_Absolute_Address" WithKind:XMLTypeNetPort] stringByAppendingFormat:@"%@", [NSString stringWithFormat:@"/Share/Article/info/id/%@.html",self.infoID]];
