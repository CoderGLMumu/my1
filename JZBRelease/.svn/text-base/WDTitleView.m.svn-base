...
- (instancetype)initTypeStr:(NSString *) str WithFrame:(CGRect) frame{
    ...
    if (self) {
        ...
        [imageView setImage:[UIImage imageNamed:@"BB_BLUELINE"]];
        ...
        UIImageView *imageView1 = [[UIImageView alloc]initWithFrame:CGRectMake(self.btn.frame.size.width - 20.5, (frame.size.height - 8) / 2.0, 7, 8)];
        [imageView1 setImage:[UIImage imageNamed:@"BB_rightarrow"]];
