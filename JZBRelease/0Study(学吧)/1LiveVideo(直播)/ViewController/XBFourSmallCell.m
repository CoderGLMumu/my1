...
- (void)setHotModel:(HotModel *)hotModel{
    ...
    if (!self.smallView0) {
        self.smallView0 = [[XBSmallView alloc]initWithFrame:CGRectMake(0, 40, GLScreenW / 2, 115 + 8 + 39)];
    ...
    if (hotModel.hot_list.count > 1) {
        if (!self.smallView1) {
            self.smallView1 = [[XBSmallView alloc]initWithFrame:CGRectMake(GLScreenW / 2, 40, GLScreenW / 2, 115 + 8 + 39)];
    ...
    if (hotModel.hot_list.count > 2) {
        if (!self.smallView2) {
            self.smallView2 = [[XBSmallView alloc]initWithFrame:CGRectMake(0, 40 + 115 + 39, GLScreenW / 2, 115  + 39)];
        ...
        height = 40 + (115 + 8 + 39) * 2 - 8;
    }
    if (hotModel.hot_list.count > 3) {
        if (!self.smallView3) {
            self.smallView3 = [[XBSmallView alloc]initWithFrame:CGRectMake(GLScreenW / 2, 40 + 115  + 39, GLScreenW / 2, 115 + 39)];
