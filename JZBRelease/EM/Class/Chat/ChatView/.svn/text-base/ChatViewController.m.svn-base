...
//    self.navigationItem.leftBarButtonItem = leftBtnItem;
    ...
    if (self.conversation.type == EMConversationTypeChat) {
        ...
        image = [UIImage originImage:image scaleToSize:CGSizeMake(20, 20)];
        image = [image imageWithTintColor:[UIColor hx_colorWithHexRGBAString:@"ffffff"]];
        ...
        [detailButton setImage:[[UIImage originImage:[UIImage imageNamed:@"group_detail"] scaleToSize:CGSizeMake(25, 25)] imageWithTintColor:[UIColor hx_colorWithHexRGBAString:@"ffffff"]] forState:UIControlStateNormal];
   ...
   didSelectAvatarMessageModel:(id<IMessageModel>)messageModel
{
    ...
    HXDataHelper *helper = [HXDataHelper new];
    NSString *uid = [helper changeUidWithHXid:messageModel.message.from];
...
//    model.nickname = @"123456";
//    NSLog(@"IMessageModel==%@",model.nickname);
//    UserProfileEntity *profileEntity = [[UserProfileManager sharedInstance] getUserProfileByUsername:model.nickname];
    
    model.avatarImage = [UIImage imageNamed:@"HX_img_head"];
    //[UIImage imageNamed:@"EaseUIResource.bundle/user"]
