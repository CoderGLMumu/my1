...
- (void)viewDidLoad
{
    ...
    footerView.frame = CGRectMake(0, 0, 100, 40);
    footerView.text = [NSString stringWithFormat:@"共%d张照片",self.allOfImage];
...
//    [leftBtn addTarget:self action:@selector(leftBarBtn) forControlEvents:UIControlEventTouchUpInside];
...
//创建工具栏
    ...
    UIBarButtonItem *customItem1;
    UIBarButtonItem *customItem2;
    UIButton *btn1 = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 50, 35)];
    [btn1 setTitle:@"取消" forState:UIControlStateNormal];
    [btn1 setTitleColor:[UIColor hx_colorWithHexRGBAString:@"757575"] forState:UIControlStateNormal];
    btn1.titleLabel.font = [UIFont systemFontOfSize:15];
    [btn1 addTarget:self action:@selector(toolBarItem1:) forControlEvents:UIControlEventTouchUpInside];
    
    UIButton *btn2 = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 50, 35)];
    [btn2 setTitle:@"确定" forState:UIControlStateNormal];
    [btn2 setTitleColor:[UIColor hx_colorWithHexRGBAString:@"1976d2"] forState:UIControlStateNormal];
    btn2.titleLabel.font = [UIFont systemFontOfSize:15];
    [btn2 addTarget:self action:@selector(toolBarItem2:) forControlEvents:UIControlEventTouchUpInside];
    customItem1 = [[UIBarButtonItem alloc]initWithCustomView:btn1];
    customItem2 = [[UIBarButtonItem alloc]initWithCustomView:btn2];
...
-(void)configNav
{
    ...
    UIImageView *backImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, (35-20)/2, 20, 20)];
    [backImageView setImage:[UIImage imageNamed:@"DL_light_ARROW"]];
    ...
    [back addTarget:self action:@selector(leftBarBtn) forControlEvents:UIControlEventTouchUpInside];
...
- (void)preparePhotos
{
    @autoreleasepool {
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            ...
            [self.navigationItem setTitle:self.singleSelection ? @"选择一张照片" : self.navTitle];
        });
    }
}
