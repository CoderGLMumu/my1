...
@interface PerAskAndAnswerVC ()<UITableViewDelegate,UITableViewDataSource,TableViewCellDelegate>{
...
@implementation PerAskAndAnswerVC
                ...
                sendAndget.returnDict = ^(NSDictionary *dict){
                    if (1 == [[dict objectForKey:@"state"] intValue]) {
                        ...
                        if (self.segment.selectedSegmentIndex == 0) {
                            ...
                            self.answerAry = [self cellWithDataAry:ary];
                        }
                        ...
                        [LoginVM getInstance].isGetToken = ^(){
                            ...
                            if (self.segment.selectedSegmentIndex == 0) {
                                ...
                                [wsend dictFromNet:model WithRelativePath:@"PerAnswer_Get_Question_Lis"];
                            }
...
-(void)sameAsk:(TableViewCell *) cell WithLayout:(CellLayout *) layout AtIndexPath:(NSIndexPath *) indexPath{
    ...
    __weak PerAskAndAnswerVC *wself = self;
