...
@interface FansListVC ()<UITableViewDelegate,UITableViewDataSource>
...
static NSString* ID = @"FansListCell";
...
//    tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"WDFansCell" bundle:nil] forCellReuseIdentifier:ID];
