...
//    self.compLView.hidden = NO;
    ...
    [self.avaImageView sd_setImageWithURL:[NSURL URLWithString:[[ValuesFromXML getValueWithName:@"Images_Absolute_Address" WithKind:XMLTypeNetPort] stringByAppendingPathComponent:self.user.avatar]] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"ZCCG_TX"]];
