...
//    NSInteger activity_newNum = [udefault integerForKey:@"Message_question_newNum233"];
    ...
    return [NSString stringWithFormat:@"%ld",reference_newNum + question_newNum + activity_newNum + MessageFriend_newNum + GroupIdBadge + PInfoavatarBadge + course_LivenewNum + course_NownewNum];
}
