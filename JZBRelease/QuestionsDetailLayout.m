...
- (id)initWithContainer:(LWStorageContainer *)container
    ...
    if (self) {
            ...
            [contentTextStorage setFrame:CGRectMake(10 , dateTextStorage.bottom + 12, SCREEN_WIDTH - 20, [contentTextStorage.text sizeWithAttributes:contentTextAttrs].height)];
       ...
       /* if (!isDetail) {
        ...
        if (commentBGStorage) {
            ...
            self.cellHeight = commentBGStorage.bottom + 15;
        }else{
            self.cellHeight = contentTextStorage.bottom + 15;
        }
    }
